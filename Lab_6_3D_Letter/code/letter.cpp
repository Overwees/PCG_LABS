...
//        setQuad(15, 20, 21, 22, 23);
    ...
    setQuad(0, 0, 1, 2, 3);
        ...
        setQuad(17, 1, 0, 28, 29);
        setQuad(18, 0, 26, 30, 28);
        setQuad(19, 1, 27, 31, 29);
        setQuad(20, 27, 26, 30, 31);

        setQuad(21, 37, 36, 34, 35);

        setQuad(22, 37, 36, 32, 33);
        setQuad(23, 36, 34, 28, 32);
        setQuad(24, 34, 35, 29, 28);
        setQuad(25, 35, 37, 33, 29);
}
